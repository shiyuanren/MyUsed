...
<div id="left">
 ...
 <script type="text/javascript" src="/MyUsed/Public/Js/Admin/lists.js"></script>
    ...
    <div class="col-lg-12">
      <div class="box">
        <header class="dark">
          ...
          <div class="row">
            <div class=".col-lg-12">
              <div class=".col-lg-9"><h5>分类列表</h5></div>
              <div class=".col-lg-3">

                <a href="<?php echo U('Category/addCategory');?>" class="btn btn-default btn-sm active" role="button">新增</a>
                <input type="button" id="del-btn" class="btn btn-default btn-sm active" value="删除"/>
              </div>
          ...
          <div class="body">
           <table class="table table-hover table-bordered">
            <thead>
              <th width=2%><input type="checkbox" id="select" /></th>
              <th style="text-align: left;" width=68%>分类名称</th>
              <th style="text-align: right;" width=30%>编辑分类</th>
            </thead>
            <tbody>
              <?php if(is_array($category_lists["list"])): foreach($category_lists["list"] as $key=>$cl): ?><tr>
                  <td><input type="checkbox"  name="items[]" value='<?php echo ($cl["id"]); ?>'/></td>
                  <td><?php echo ($cl["category_name"]); ?></td>
                  <td style="text-align: right;">
                    <a href="<?php echo U('editCategory',array('id'=>$cl['id']));?>"  class="btn btn-default btn-sm active" role="button">编辑</a>
                    <a href="<?php echo U('deleteCategory',array('id'=>$cl['id']));?>"  class="btn btn-default btn-sm active" role="button">删除</a>
                  </td>
                  </tr><?php endforeach; endif; ?>
              </tbody>
              <tfoot>
                <th colspan="6"><?php echo ($category_lists["page"]); ?></th>
              </tfoot>
