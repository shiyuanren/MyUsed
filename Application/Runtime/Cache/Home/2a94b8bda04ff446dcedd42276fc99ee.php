...
<div class="navbar-wrapper">
	...
	<ul class="nav navbar-nav navbar-right scroll">
			<li  class="active" role="presentation"><a href="<?php echo U('Home/Index/index');?>"  class="navbar-link">Home</a></li>
												...
												<div class="col-md-6">
													...
													<div id="<?php echo ($gl["product_name"]); ?>" class="carousel slide">
														...
														<ol class="carousel-indicators">
															...
															<?php $__FOR_START_6390__=0;$__FOR_END_6390__=$gl["images_count"];for($i=$__FOR_START_6390__;$i < $__FOR_END_6390__;$i+=1){ ?><li data-target="#<?php echo ($gl["product_name"]); ?>" data-slide-to="<?php echo ($i+1); ?>"></li><?php } ?>
														</ol>
														<!-- Carousel items-->
